...
[![GoDoc](https://godoc.org/github.com/damoncoo/goproxy?status.svg)](https://godoc.org/github.com/damoncoo/goproxy)
[![Join the chat at https://gitter.im/damoncoo/goproxy](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/damoncoo/goproxy?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
![Status](https://github.com/damoncoo/goproxy/workflows/Go/badge.svg)
...
Get the latest goproxy from `gopkg.in/damoncoo/goproxy.v1`.
...
[the eavesdropper example](https://github.com/damoncoo/goproxy/blob/master/examples/goproxy-eavesdropper/main.go#L27)
2. Transparent proxy support for http/https including MITM certificate generation for TLS.  See the [transparent example.](https://github.com/damoncoo/goproxy/tree/master/examples/goproxy-transparent)
